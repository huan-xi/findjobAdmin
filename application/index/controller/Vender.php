...
class  Vender extends BaseController
{
    ...
    public function details(){
       ...
       $vender=VenderModel::get($vender_id);
       $this->assign('user',$vender);
       return $this->fetch();
    }
    //启用用户
    ...
    public function edit_user()
    {
        ...
        $phone = input('phone');
        $name = input('name');
        $user_id = VenderModel::get($user_id);
